...
namespace OptimizeThelia\TaxEngine;
...
class Calculator
{
    ...
    {
        $this->loadTaxRule($product->getTaxRule(), $country, $product);
    ...
    {
        $this->loadTaxRule($taxRule, $country, new Product());
